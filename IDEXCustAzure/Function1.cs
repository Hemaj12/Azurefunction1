...
namespace IDEXCustAzure
{
    public class Function1
    {
        ...
        // Fetch PaymentTermsSimple
                    ...
                    var fetchCommandSimple = new SqlCommand(fetchChangesQuerySimple, sourceConnection);
                    ...
                    var fetchCommandMilestone = new SqlCommand(fetchChangesQueryMilestone, sourceConnection);
                    ...
                    // Combine and Send in ONE API call
